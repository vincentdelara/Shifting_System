    ...
    const AddShiftComponent = ({handleModalClose3 }) => {
        ...
        const handleOvertimeChange = (date) => {
            setOvertime(date);
            setOtime(date);
          };
        
          const handleOtimeChange = (date) => {
            setOtime(date);
          };
        ...
        const maxOvertimeDate = new Date(today.getFullYear(), today.getMonth(), today.getDate() - 1);
        const minOtimeDate = overtime;
      ...
      />
                                                    ...
                                                    <DatePicker
        selected={otime}
        onChange={handleOtimeChange}
        dateFormat="MMMM d, yyyy"
        className="form-control rc"
        maxDate={today}
        minDate={minOtimeDate}
      />
                                                </div></td>
